...
fun MainSettings(
    ...
    Column {
        VideoSettingItem(R.drawable.cloud, "Sources", focusRequester) {
            onSettingSelected(SettingsScreen.SOURCES)
        }
        VideoSettingItem(R.drawable.hd_icon, "Quality", focusRequester) {
            onSettingSelected(SettingsScreen.QUALITY)
        }
        VideoSettingItem(R.drawable.audio, "Audio", focusRequester) {
            onSettingSelected(SettingsScreen.AUDIO)
        }
        VideoSettingItem(R.drawable.subtitles, "Subtitle", focusRequester) {
